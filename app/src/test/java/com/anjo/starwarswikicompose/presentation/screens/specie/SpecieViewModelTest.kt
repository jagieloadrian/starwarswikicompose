...
class SpecieViewModelTest {
    ...
    @Test
    fun `given specie when getSpecie then return specie and related images`(): Unit = runTest {
        //given
        ...
        val expected =
            SpecieDetailState(specieDto = SpecieDto(id = objectId, "Title", classification = "1", designation = "mass"),
        ...
        coEvery { useCases.getSpecieUseCase(objectId) } returns expected.specieDto
