...
class PersonViewModelTest {
    ...
    @Test
    fun `given person when getPerson then return person and related images`(): Unit = runTest {
        //given
        ...
        val expected = PersonDetailState(personDto = PersonDto(id = objectId, "Title", birthYear = "1", mass = "mass"),
                state = SUCCESS)
        ...
        coEvery { useCases.getPersonUseCase(objectId) } returns expected.personDto
