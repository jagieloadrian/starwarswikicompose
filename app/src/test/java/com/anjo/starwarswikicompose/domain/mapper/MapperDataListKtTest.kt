...
class MapperDataListKtTest {
    ...
    fun `given film when mapFromFilms then return list of universalChunk`() {
        //given
        val film = listOf(
                GetAllFilmsQuery.Film(__typename = "Film", id ="objectId1", title = "name1", episodeID = 1),
                GetAllFilmsQuery.Film(__typename = "Film", id ="objectId2", title = null, episodeID = 2),
                GetAllFilmsQuery.Film(__typename = "Film", id ="objectId3", title = "name3", episodeID = null))
    ...
    fun `given person list when mapFromPersons then return list of universalChunk`() {
        //given
        val people = listOf(
                GetAllPeoplesQuery.Person(__typename = "Person", id ="objectId1", name = "name1", birthYear = "1"),
                GetAllPeoplesQuery.Person(__typename = "Person", id ="objectId2", name = null, birthYear = "2"),
                GetAllPeoplesQuery.Person(__typename = "Person", id ="objectId3", name = "name3", birthYear = null))
    ...
    fun `given planet list when mapFromPlanets then return list of universalChunk`() {
        //given
        val planets = listOf(
                GetAllPlanetsQuery.Planet(__typename = "Planet", id ="objectId1", name = "name1", population = 1.5),
                GetAllPlanetsQuery.Planet(__typename = "Planet", id ="objectId2", name = null, population = 2.5),
                GetAllPlanetsQuery.Planet(__typename = "Planet", id ="objectId3", name = "name3", population = null))
    ...
    fun `given specie list when mapFromSpecies then return list of universalChunk`() {
        //given
        val specie = listOf(
                GetAllSpeciesQuery.Species(__typename = "Species", id ="objectId1", name = "name1", language = "1"),
                GetAllSpeciesQuery.Species(__typename = "Species", id ="objectId2", name = null, language = "2"),
                GetAllSpeciesQuery.Species(__typename = "Species", id ="objectId3", name = "name3", language = null))
    ...
    fun `given vehicle list when mapFromVehicles then return list of universalChunk`() {
        //given
        val vehicles = listOf(
                GetAllVehiclesQuery.Vehicle(__typename = "Vehicle", id ="objectId1", name = "name1", model = "1"),
                GetAllVehiclesQuery.Vehicle(__typename = "Vehicle", id ="objectId2", name = null, model = "2"),
                GetAllVehiclesQuery.Vehicle(__typename = "Vehicle", id ="objectId3", name = "name3", model = null))
    ...
    fun `given starship list when mapFromStarships then return list of universalChunk`() {
        //given
        val starship = listOf(
                GetAllStarshipsQuery.Starship(__typename = "Starship", id ="objectId1", name = "name1", model = "1"),
                GetAllStarshipsQuery.Starship(__typename = "Starship", id ="objectId2", name = null, model = "2"),
                GetAllStarshipsQuery.Starship(__typename = "Starship", id ="objectId3", name = "name3", model = null))
