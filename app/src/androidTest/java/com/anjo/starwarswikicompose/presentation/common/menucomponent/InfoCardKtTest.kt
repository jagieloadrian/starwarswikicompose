...
import com.anjo.starwarswikicompose.BuildConfig.DEBUG
import com.anjo.starwarswikicompose.BuildConfig.VERSION_CODE
import com.anjo.starwarswikicompose.BuildConfig.VERSION_NAME
...
class InfoCardKtTest {
    ...
    fun givenInfoDialogScreen_whenDisplay_thenVerifyComponents() {
        ...
        val versionValue = composeTestRule.onNodeWithText(VERSION_NAME)
        ...
        val isDebugModeValue = composeTestRule.onNodeWithText(DEBUG.toString())
        isDebugModeValue.assertIsDisplayed()
        isDebugModeValue.assertIsEnabled()

        val year = LocalDateTime.now().year

        val copyright = composeTestRule.onNodeWithText("Copyright © $year, d18")
